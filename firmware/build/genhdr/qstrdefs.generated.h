...
QDEF(MP_QSTR_ECC_HIGH, (const byte*)"\xb1\x1f\x08" "ECC_HIGH")
QDEF(MP_QSTR_ECC_LOW, (const byte*)"\x8b\x73\x07" "ECC_LOW")
QDEF(MP_QSTR_ECC_MEDIUM, (const byte*)"\x82\x86\x0a" "ECC_MEDIUM")
QDEF(MP_QSTR_ECC_QUARTILE, (const byte*)"\x1c\xd8\x0c" "ECC_QUARTILE")
...
QDEF(MP_QSTR_EPSPI, (const byte*)"\x3a\x26\x05" "EPSPI")
...
QDEF(MP_QSTR_QR, (const byte*)"\x26\x74\x02" "QR")
