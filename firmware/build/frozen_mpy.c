...
enum {
    MP_QSTR_apa102_dot_py = MP_QSTRnumber_of,
    MP_QSTR_NeoPixel,
    MP_QSTR_neopixel,
    MP_QSTR_APA102,
    MP_QSTR_ORDER,
...
const qstr_pool_t mp_qstr_frozen_const_pool = {
    ...
    199, // used entries
    {
        (const byte*)"\x21\xef\x09" "apa102.py",
        (const byte*)"\x69\x83\x08" "NeoPixel",
        (const byte*)"\x69\xa0\x08" "neopixel",
        (const byte*)"\xa6\x4e\x06" "APA102",
        (const byte*)"\x4b\x69\x05" "ORDER",
        (const byte*)"\x85\x01\x09" "clock_pin",
        (const byte*)"\x79\x77\x04" "self",
        (const byte*)"\x3d\xc6\x08" "data_pin",
...
// frozen bytecode for file apa102.py, scope apa102__lt_module_gt__APA102___init__
STATIC const byte bytecode_data_apa102__lt_module_gt__APA102___init__[54] = {
    0x0b, 0x00, 0x00, 0x06, 0x00, 0x01, 0x0b,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    MP_QSTR_apa102_dot_py & 0xff, MP_QSTR_apa102_dot_py >> 8,
    0x81, 0x0b, 0x2f, 0x25, 0x00, 0x00, 0xff,
    ...
    0xb2, 
    0xb1, 
    0x26, MP_QSTR_clock_pin & 0xff, MP_QSTR_clock_pin >> 8, 
    0xb1, 
    0x1d, MP_QSTR_clock_pin & 0xff, MP_QSTR_clock_pin >> 8, 
...
STATIC const mp_rom_obj_t const_table_data_apa102__lt_module_gt__APA102___init__[6] = {
    MP_ROM_QSTR(MP_QSTR__star_),
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_clock_pin),
    MP_ROM_QSTR(MP_QSTR_data_pin),
    MP_ROM_QSTR(MP_QSTR_n),
    MP_ROM_QSTR(MP_QSTR_bpp),
};
STATIC const mp_raw_code_t raw_code_apa102__lt_module_gt__APA102___init__ = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 6,
    .data.u_byte = {
        .bytecode = bytecode_data_apa102__lt_module_gt__APA102___init__,
        .const_table = (mp_uint_t*)const_table_data_apa102__lt_module_gt__APA102___init__,
...
// frozen bytecode for file apa102.py, scope apa102__lt_module_gt__APA102_write
STATIC const byte bytecode_data_apa102__lt_module_gt__APA102_write[36] = {
    0x05, 0x00, 0x00, 0x01, 0x00, 0x00, 0x09,
    MP_QSTR_write & 0xff, MP_QSTR_write >> 8,
    MP_QSTR_apa102_dot_py & 0xff, MP_QSTR_apa102_dot_py >> 8,
    0x81, 0x10, 0x00, 0x00, 0xff,
    0x1c, MP_QSTR_apa102_write & 0xff, MP_QSTR_apa102_write >> 8, 
    0xb0, 
    0x1d, MP_QSTR_clock_pin & 0xff, MP_QSTR_clock_pin >> 8, 
    0xb0, 
...
STATIC const mp_rom_obj_t const_table_data_apa102__lt_module_gt__APA102_write[1] = {
    MP_ROM_QSTR(MP_QSTR_self),
};
STATIC const mp_raw_code_t raw_code_apa102__lt_module_gt__APA102_write = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 1,
    .data.u_byte = {
        .bytecode = bytecode_data_apa102__lt_module_gt__APA102_write,
        .const_table = (mp_uint_t*)const_table_data_apa102__lt_module_gt__APA102_write,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 36,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file apa102.py, scope apa102__lt_module_gt__APA102
STATIC const byte bytecode_data_apa102__lt_module_gt__APA102[59] = {
    0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0c,
    MP_QSTR_APA102 & 0xff, MP_QSTR_APA102 >> 8,
    MP_QSTR_apa102_dot_py & 0xff, MP_QSTR_apa102_dot_py >> 8,
    0x8e, 0x08, 0x49, 0x6b, 0x40, 0x00, 0x00, 0x00, 0xff,
    0x1b, MP_QSTR___name__ & 0xff, MP_QSTR___name__ >> 8, 
    0x24, MP_QSTR___module__ & 0xff, MP_QSTR___module__ >> 8, 
    0x16, MP_QSTR_APA102 & 0xff, MP_QSTR_APA102 >> 8, 
...
STATIC const mp_rom_obj_t const_table_data_apa102__lt_module_gt__APA102[2] = {
    MP_ROM_PTR(&raw_code_apa102__lt_module_gt__APA102___init__),
    MP_ROM_PTR(&raw_code_apa102__lt_module_gt__APA102_write),
};
STATIC const mp_raw_code_t raw_code_apa102__lt_module_gt__APA102 = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 0,
    .data.u_byte = {
        .bytecode = bytecode_data_apa102__lt_module_gt__APA102,
        .const_table = (mp_uint_t*)const_table_data_apa102__lt_module_gt__APA102,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 59,
        .n_obj = 0,
        .n_raw_code = 2,
...
// frozen bytecode for file apa102.py, scope apa102_<module>
STATIC const byte bytecode_data_apa102__lt_module_gt_[65] = {
    0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_apa102_dot_py & 0xff, MP_QSTR_apa102_dot_py >> 8,
    0x61, 0x30, 0x70, 0x00, 0x00, 0xff,
    0x80, 
    0x16, MP_QSTR_apa102_write & 0xff, MP_QSTR_apa102_write >> 8, 
    0x50, 0x01, 
    0x68, MP_QSTR_esp & 0xff, MP_QSTR_esp >> 8, 
    0x69, MP_QSTR_apa102_write & 0xff, MP_QSTR_apa102_write >> 8, 
    0x24, MP_QSTR_apa102_write & 0xff, MP_QSTR_apa102_write >> 8, 
    0x32, 
    0x80, 
    ...
    0x64, 0x03, 
    0x24, MP_QSTR_APA102 & 0xff, MP_QSTR_APA102 >> 8, 
    0x11, 
    0x5b, 
};
STATIC const mp_rom_obj_t const_table_data_apa102__lt_module_gt_[1] = {
    MP_ROM_PTR(&raw_code_apa102__lt_module_gt__APA102),
};
const mp_raw_code_t raw_code_apa102__lt_module_gt_ = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 0,
    .data.u_byte = {
        .bytecode = bytecode_data_apa102__lt_module_gt_,
        .const_table = (mp_uint_t*)const_table_data_apa102__lt_module_gt_,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 65,
        .n_obj = 0,
        .n_raw_code = 1,
...
STATIC const mp_obj_str_t const_obj_inisetup__lt_module_gt__wifi_0 = {{&mp_type_bytes}, 36592, 14, (const byte*)"\x4d\x69\x63\x72\x6f\x50\x79\x74\x68\x6f\x6e\x2d\x25\x73"};
STATIC const mp_obj_str_t const_obj_inisetup__lt_module_gt__wifi_1 = {{&mp_type_bytes}, 31787, 11, (const byte*)"\x6d\x69\x63\x72\x6f\x70\x79\x74\x68\x6f\x4e"};
...
STATIC const byte bytecode_data_inisetup__lt_module_gt__setup[115] = {
    ...
    MP_QSTR_inisetup_dot_py & 0xff, MP_QSTR_inisetup_dot_py >> 8,
    0x81, 0x23, 0x26, 0x28, 0x26, 0x2f, 0x2c, 0x2d, 0x2f, 0x8d, 0x0b, 0x00, 0x00, 0xff,
...
STATIC const mp_obj_str_t const_obj_inisetup__lt_module_gt__setup_1 = {{&mp_type_str}, 58788, 230, (const byte*)""};
...
STATIC const byte bytecode_data_neopixel__lt_module_gt__NeoPixel___init__[63] = {
    0x07, 0x00, 0x00, 0x04, 0x00, 0x01, 0x0d,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    MP_QSTR_neopixel_dot_py & 0xff, MP_QSTR_neopixel_dot_py >> 8,
    0x81, 0x0a, 0x25, 0x25, 0x25, 0x2c, 0x00, 0x00, 0xff,
    0xb1, 
    0xb0, 
    0x26, MP_QSTR_pin & 0xff, MP_QSTR_pin >> 8, 
    0xb2, 
...
STATIC const mp_rom_obj_t const_table_data_neopixel__lt_module_gt__NeoPixel___init__[4] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_pin),
    MP_ROM_QSTR(MP_QSTR_n),
    MP_ROM_QSTR(MP_QSTR_bpp),
...
STATIC const byte bytecode_data_neopixel__lt_module_gt__NeoPixel___setitem__[63] = {
    ...
    MP_QSTR_neopixel_dot_py & 0xff, MP_QSTR_neopixel_dot_py >> 8,
    0x81, 0x11, 0x27, 0x2a, 0x00, 0x00, 0xff,
    0xb1, 
    0xb0, 
...
STATIC const byte bytecode_data_neopixel__lt_module_gt__NeoPixel___getitem__[53] = {
    ...
    MP_QSTR_neopixel_dot_py & 0xff, MP_QSTR_neopixel_dot_py >> 8,
    0x83, 0x16, 0x29, 0x28, 0x00, 0x00, 0x00, 0x02, 0xff,
    0xb1, 
    0x1a, 0x00, 
    0x1d, MP_QSTR_bpp & 0xff, MP_QSTR_bpp >> 8, 
    0xf3, 
...
STATIC const byte bytecode_data_neopixel__lt_module_gt__NeoPixel_write[33] = {
    0x05, 0x00, 0x00, 0x01, 0x00, 0x00, 0x09,
    MP_QSTR_write & 0xff, MP_QSTR_write >> 8,
    MP_QSTR_neopixel_dot_py & 0xff, MP_QSTR_neopixel_dot_py >> 8,
...
STATIC const byte bytecode_data_neopixel__lt_module_gt__NeoPixel[77] = {
    0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12,
    MP_QSTR_NeoPixel & 0xff, MP_QSTR_NeoPixel >> 8,
    MP_QSTR_neopixel_dot_py & 0xff, MP_QSTR_neopixel_dot_py >> 8,
    0x8d, 0x07, 0x49, 0x89, 0x07, 0x65, 0x40, 0x65, 0x40, 0x65, 0x20, 0x00, 0x00, 0xff,
    0x1b, MP_QSTR___name__ & 0xff, MP_QSTR___name__ >> 8, 
    0x24, MP_QSTR___module__ & 0xff, MP_QSTR___module__ >> 8, 
    0x16, MP_QSTR_NeoPixel & 0xff, MP_QSTR_NeoPixel >> 8, 
    0x24, MP_QSTR___qualname__ & 0xff, MP_QSTR___qualname__ >> 8, 
...
const mp_raw_code_t *const mp_frozen_mpy_content[] = {
    &raw_code_apa102__lt_module_gt_,
